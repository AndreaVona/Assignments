...
static const uint8_t deveui[LORAMAC_DEVEUI_LEN] = { 0x00, 0xAB, 0x56, 0x25, 0x31, 0x33, 0x49, 0xEF };
static const uint8_t appeui[LORAMAC_APPEUI_LEN] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0xE0, 0xFD };
static const uint8_t appkey[LORAMAC_APPKEY_LEN] = { 0x2B, 0x67, 0x85, 0x47, 0xAC, 0x5B, 0xBA, 0x9D, 0x3E, 0x74, 0x10, 0xCF, 0x7E, 0xBD, 0x28, 0xE1 };
