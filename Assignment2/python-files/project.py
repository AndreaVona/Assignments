...
client2 = mqtt.Client("python2")     #create new instance of the mqtt client
...
username="nPYOEsgYdx73gcVU2VFR" #Station-1 id token: has to be get by the payload of the sensor
password=""
client1.username_pw_set(username, password)
client1.connect(broker,portDemo)      #establish connection with client1

#need to edit user name 
username2="FvEzUeX949r31crGraJG" #Station-2 id toke
password2=""
client2.username_pw_set(username2, password2)
client2.connect(broker,portDemo)      #establish connection with client2
